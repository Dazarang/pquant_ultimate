...
- What is presented here is MERELY A GUIDELINE and should be treated as such.
...
# CORRECTION 1: Labeling Philosophy 

## ✅ The Labeling Approach is CORRECT
...
## 2.1 Raw Data Format (After Loading Tickers)
...
## 2.4 Train/Val/Test Split Structure
...
## 2.5 Feature Matrix for Model Training
...
## 2.7 Data Storage Recommendations
...
## 2.1 The Golden Rule: NO FUTURE INFORMATION
...
## 4.2 Walk-Forward Validation (Advanced Alternative)
...
# ❌ Using center=True without shifting labels
pivot_low = rolling(window=17, center=True)  # Uses 8 future days
