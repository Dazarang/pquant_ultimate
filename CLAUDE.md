...
**Default behavior:** Spin up team agents (`model: "opus"`) for research, exploration, and implementation. You are the coordinator — don't waste main context on work agents should do. Delegate first, synthesize results, act.
